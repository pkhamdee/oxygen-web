...
export const globalSalesValues = {
  ...
  //   name: ({ random }) => Math.round(random() * 0.5 * 1000) / 1000,
  name1: ["Jane Joe"],
  //   tel: ({ random }) => generateDate({
  //     random,
  //     year: 2016,
...
// export var values = function() {
async function valueName() {
  //let res;
...
export const globalSalesValues2 = {
  region: [
    "Asia",
    "Europe",
    "North America",
